...
CREATE_NODE, NODE_NAME, NODE_ADDRESS, NODE_PORT, NODE_TLS, SELECT_INBOUNDS = range(19, 25)

# Состояния работы с хостами
EDIT_HOST, EDIT_HOST_FIELD, CREATE_HOST = range(25, 28)

# Состояния работы с inbound'ами
EDIT_INBOUND, EDIT_INBOUND_FIELD, CREATE_INBOUND = range(28, 31)

# Поисковые состояния
SEARCH_USERS, SEARCH_NODES, SEARCH_HOSTS, SEARCH_INBOUNDS = range(31, 35)
