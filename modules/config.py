...
EDIT_HOST, EDIT_HOST_FIELD, CREATE_HOST = range(27, 30)

# Состояния работы с inbound'ами
EDIT_INBOUND, EDIT_INBOUND_FIELD, CREATE_INBOUND = range(30, 33)

# Поисковые состояния
SEARCH_USERS, SEARCH_NODES, SEARCH_HOSTS, SEARCH_INBOUNDS = range(33, 37)
...
def get_all_states():
    ...
    return [
        ...
        CREATE_NODE, CREATE_NODE_FIELD, NODE_NAME, NODE_ADDRESS, NODE_PORT, NODE_TLS, SELECT_INBOUNDS,
        # Host operations
